...
三档浏览器实际覆盖：首页首屏切换、资讯轮播、桌面/移动导航及搜索、移动抽屉焦点闭环、产品 dialog、服务地区查询与 FAQ、智能场景、合作区域选择、联系预检、关键词搜索、资讯第 1→2→3 页的客户端导航，以及浮动咨询、返回顶部、路由幕布和 reduced-motion 降级。
