...
export function ServicePage({ page }: { page: PageData }) {
  return <main id="main-content" className={styles.page}>
    ...
    <section className={styles.supportCta}><div><p className={styles.sectionLabel}>NEED MORE SUPPORT?</p><h2>没有找到需要的信息？</h2></div><Link href={consultationHref("project", "service-network")}>联系钜豪<span>→</span></Link></section>
  </main>;
}
