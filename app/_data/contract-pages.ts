...
export const contractPages = {
  ...
  "privacy": {
    ...
    sections: [
      { title: "何时收集", text: "第一步“检查准备情况”只在当前页面整理内容。只有访客主动选择“提交回访”、勾选同意并提交后，需求与联系信息才会发送到官网同源接口并保存。直接拨打电话或新建邮件时，由对应通信工具处理后续联系。企业微信入口在核验前保持关闭。" },
      ...
      { title: "查阅、更正与删除", text: "如需查询、更正或删除主动提交的回访信息，请提供线索编号并联系钜豪：服务热线 400-0760-888，邮箱 export@juhaolamp.com。企业应在核验身份和适用流程后处理。" },
