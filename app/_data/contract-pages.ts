...
export const contractPages = {
  ...
  "privacy": {
    ...
    sections: [
      ...
      { title: "第一方最小分析（默认关闭）", text: "第一方最小分析披露版本均为 2026-07-22。该功能默认关闭，只有完成浏览器构建、D1、边缘限流和隐私签核后才可同时开启；不接收或保存 Cookie、用户或会话 ID、IP、User-Agent、完整 URL、查询参数、联系方式或咨询正文。第一方分析日聚合记录设置 400 日到期时间，仅用于方向性趋势与漏斗观察。" },
